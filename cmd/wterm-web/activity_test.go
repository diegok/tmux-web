...
// is about. It is not about secrecy: anything that can read @wterm_agent can
...
func TestActivityFromToolCall(t *testing.T) {
	for _, tc := range []struct {
		...
		{"opencode spells it filePath", "write", "write out.txt",
			map[string]any{"filePath": "/tmp/wterm-capture/oc/proj/out.txt"}},
		...
		{"opencode's edit permission spells it filepath", "edit", "edit note.txt",
			map[string]any{"filepath": "/tmp/wterm-capture/oc/proj/note.txt"}},
